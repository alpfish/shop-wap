...
export default {
  ...
  ready() {
    let header = document.getElementById('page-header-box')
    let bottom = document.getElementById('page-bottom')
    this.headerHeight = _.isNull(header.clientHeight) ? 0 : _.toInteger(header.clientHeight)
    this.bottomHeight = _.isNull(bottom.clientHeight) ? 0 : _.toInteger(bottom.clientHeight)
  },
}
</script>
